      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="<?=$action?>" class="row g-3 needs-validation <?=$was_validated?>" method="POST" novalidate>
            ...
            <div class="col-12">
              <label for="inputPassword4" class="form-label">Jumlah Pembelian</label>
              <input type="text" name="qty" class="form-control number" value="<?=number_format($qty)?>" required>
            </div>
            
            <div class="col-12">
              <label for="inputPassword4" class="form-label">Harga Satuan</label>
              <input type="text" name="price" class="form-control number" value="<?=number_format($price)?>" required>
            </div>
            <div class="col-12">
              <label for="inputPassword4" class="form-label">Deskripsi Pembelian</label>
