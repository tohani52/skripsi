              ...
              <table class="table datatable">
                ...
                <tbody>
                      ...
                      if($value['proccess'] > 0 && $value['proccess'] <= count($approver)){
                        ...
                        foreach ($list_user as $key => $value2) {
                          if($approver[$value['proccess']-1] == $value2['id']){
                            ...
                            if($this->session->get("id_user") == $approver[$value['proccess']-1] ){
                              $owner = true;
                            }
                          }
                        }
                  ...
                  <tr>
                    ...
                    <td><?= $status?></td>
                    <td>
                        <a id="<?=$value['id']?>" href="#" class="btn btn-primary shadow btn-xs sharp" title="approve" onclick="approval_pengajuan(<?=$value['id']?>)"><i class="bi bi-hand-thumbs-up-fill"></i></a>
                        <a id="<?=$value['id']?>" href="#" class="btn btn-danger shadow btn-xs sharp" title="reject" onclick="reject_pengajuan(<?=$value['id']?>)"><i class="bi bi-hand-thumbs-down-fill"></i></a>
                      </td>
                  </tr>
                  <?php } 
                  }?>
