                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><?= $judul_page ?>
                            <a href="<?= $add ?>" class="btn btn-primary shadow btn-xs sharp me-1"> Tambah
                                <?= $judul_page ?>
                ...
                ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/submit_productout/<?= $value['id'] ?>"
                                            class="btn btn-secondary shadow btn-xs sharp me-1"><i
                                                class="bi bi-send"></i></a>

                                        <a href="<?= $update . '/' . $value['request_code'] ?>"
                                            class="btn btn-warning shadow btn-xs sharp me-1"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <a id="<?= $value['id'] ?>" href="#"
                                            class="btn btn-danger shadow btn-xs sharp hapus"
                                            onclick="myFunction(<?= $value['id'] ?>)"><i
                                                class="bi bi-trash-fill"></i></a>
                                        <?php } else {

                      ?>

                                        <a href="/cetak_productout/<?= $value['id'] ?>" target="_blank"
