...
<head>
  ...
  <link href="<?=base_url()?>/assets-admin/img/logo_pudc.png" rel="icon">
</head>
<style>
...
form {
  ...
  transform: translate(
    -50%,
    -50%
  ); /* Adjusting position to ensure perfect centering */
}
...
div.right div {
  ...
  transform: translate(
    -50%,
    -50%
  ); /* Adjusting position for perfect centering */
  box-sizing: border-box; /* Ensuring consistent box model */
}
    ...
    <form action="/login_action" method="POST" id="Login">
      ...
      <div class="left">
        <div>
          <!-- Welcome message and registration link -->
			...
			<img src="<?=base_url()?>/assets-admin/img/logo_pudc.png" width="200"alt="">
      ...
      <div class="right">
        <div>
		  ...
		  <input type="text" placeholder="Username" required="" id="username" name="user_name" autofocus/>
