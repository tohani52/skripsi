...
class Productout extends BaseController
{
    ...
    public function cetak($id){
        ...
        $ttd = base64_encode(file_get_contents('assets-admin/img/ttd/'.$user1['photo_ttd']));
        $ttd2 = base64_encode(file_get_contents('assets-admin/img/ttd/'.$user2['photo_ttd']));
        $ttd3 = base64_encode(file_get_contents('assets-admin/img/ttd/'.$user3['photo_ttd']));
        $data =[
